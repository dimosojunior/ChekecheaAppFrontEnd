...
const FutaMwanafunzi2 = ({navigation, route}) => {
...
const handleDeletePost = async () => {
    ...
    try {
      await axios.delete(EndPoint + `/DeleteStudentsPostView/${postId}/delete/`, {
        headers: {
...
<View style={{
  ...
  }}>Taarifa zaidi za  {JinaKamiliLaMwanafunzi}</Text>
</View>
...
export default FutaMwanafunzi2;
