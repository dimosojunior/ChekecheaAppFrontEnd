...
const AddMwanafunzi = ({ navigation }) => {
...
const [SimuYaMzazi_2, setSimuYaMzazi_2] = useState('');
  ...
  const handleErrorMessage = (error) => {
    if (error.response) {
      ...
      showAlertFunction('Kuna tatizo kwenye usajili wa mwanafunzi mpya');
      setIsLoading(false);
    }
  };
...
const handleRegistration = async () => {
    ...
    if (userToken) {
        ...
        if (selectedJinaLaKituo) {
          ...
          showAlertFunction('Tafadhali chagua jina la kituo unachomuandikisha mwanafunzi.');
          setIsLoading(false);
          return;
        }
         ...
         if (selectedDarasa) {
          ...
          showAlertFunction('Tafadhali chagua Darasa analoandikishwa mwanafunzi.');
          setIsLoading(false);
          return;
        }
        ...
        if (selectedMkondo) {
         ...
         if (SimuYaMzazi_1) {
            ...
            showAlertFunction('Tafadhali ingiza namba ya simu ya mzazi ya 1 ');
            setIsLoading(false);
            return;
        }
            ...
            showAlertFunction('Tafadhali ingiza namba ya simu ya mzazi ya 2 ');
            setIsLoading(false);
            return;
        }
  ...
  if (!SimuYaMzazi_1.startsWith("0")) {
    showAlertFunction("Namba ya simu lazima ianze na 0");
    return;
  }

  if (SimuYaMzazi_1.length !== 10) {
    ...
    return;
           ...
           // Validate phone number
  if (!SimuYaMzazi_2.startsWith("0")) {
    showAlertFunction("Namba ya simu lazima ianze na 0");
    return;
  }

  if (SimuYaMzazi_2.length !== 10) {
    showAlertFunction("Namba ya simu lazima iwe na tarakimu 10");
    return;
  }
        ...
        if (MaelezoYaMwanafunzi) {
            formData.append('MaelezoYaMwanafunzi', MaelezoYaMwanafunzi);
        } 

        // Ongeza picha kwenye `FormData` tu kama imechaguliwa
        if (PichaYaMwanafunzi) {
            formData.append('PichaYaMwanafunzi', {
                uri: PichaYaMwanafunzi,
                name: 'PichaYaMwanafunzi.jpg',
                type: 'image/jpeg',
            });
        }
        ...
        axios.post(EndPoint + '/AddStudentsView/', formData, {
            headers: {
            ...
            setIsLoading(false);
            showAlertFunction("Umefanikiwa Kumsajili mwanafunzi mpya");
            setdisplayContentsState(true);
            //console.log("Well");
            setJinaKamiliLaMwanafunzi('');
            
            setPichaYaMwanafunzi('');
            setMaelezoYaMwanafunzi('');
            setSimuYaMzazi_1(0);
            setSimuYaMzazi_2(0);
          ...
          <View style={styles.container}>
            ...
            <View style={styles.forgotDes}>
              <Text style={styles.forgotDesLbl}>
                Ingiza taarifa kwa usahihi kuweza kumsajili mwanafunzi
              </Text>
