...
const FutaDarasa = ({navigation, route}) => {
...
const handleDeletePost = async () => {
    ...
    try {
      await axios.delete(EndPoint + `/DeleteMadarasaView/${postId}/delete/`, {
        headers: {
          Authorization: `Token ${userToken}`,
        },
      });
      navigation.goBack();
      Alert.alert('Umefanikiwa kufuta Darasa');
   ...
   if (error.response && error.response.data && error.response.data.error) {
      ...
      Alert.alert('Imeshindikana kufuta Darasa');
    }
