...
const FutaMwanafunziAttendence = ({navigation, route}) => {
...
const handleDeletePost = async () => {
    ...
    try {
      await axios.delete(EndPoint + `/DeleteStudentAttendenceCartView/${postId}/delete/`, {
        headers: {
          Authorization: `Token ${userToken}`,
        },
      });
      navigation.goBack();
      Alert.alert('Umefanikiwa kufuta mwanafunzi');
   ...
   if (error.response && error.response.data && error.response.data.error) {
      ...
      Alert.alert('Imeshindikana kufuta mwanafunzi');
    }
...
<View style={{
  ...
  }}>Mfute  {JinaKamiliLaMwanafunzi}</Text>
</View>
...
export default FutaMwanafunziAttendence;
