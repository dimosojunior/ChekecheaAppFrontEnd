...
const ItaAttendence = ({navigation, route}) => {
...
const addCartItem = async () => {
  ...
  try {
    ...
    // Ensure that the response contains the 'id' of the newly added item
     ...
     Alert.alert("umefanikiwa kumuita mwanafunzi" + " " + JinaKamiliLaMwanafunzi);
...
<View style={{
  ...
  }}>Muite {JinaKamiliLaMwanafunzi}</Text>
</View>
