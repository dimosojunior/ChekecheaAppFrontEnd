...
const FutaMatokeo = ({navigation, route}) => {
...
const handleDeletePost = async () => {
    ...
    try {
      await axios.delete(EndPoint + `/DeleteMatokeoYaMwanafunziMmojaView/${postId}/delete/`, {
        headers: {
          Authorization: `Token ${userToken}`,
        },
      });
      navigation.goBack();
      Alert.alert('Umefanikiwa kufuta matokeo');
   ...
   if (error.response && error.response.data && error.response.data.error) {
      ...
      Alert.alert('Imeshindikana kufuta matokeo');
    }
...
<View style={{
  ...
  }}>Futa matokeo ya  {JinaKamiliLaMwanafunzi}</Text>
</View>
