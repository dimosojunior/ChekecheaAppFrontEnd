...
const MikondoYoteAngaliaMatokeo = ({ navigation, route }) => {
...
const handlePressDetailsPage = (item) =>
    navigation.navigate('Wanafunzi Wote Angalia Matokeo', { ...item, Darasa, KiasiChaAda });
...
export default MikondoYoteAngaliaMatokeo;
